...
public class LoanResponse {
  ...
  private @Nullable LocalDate borrowDate;

  @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
  private @Nullable LocalDate returnDate;
  ...
  public LoanResponse borrowDate(@Nullable LocalDate borrowDate) {
   ...
   */
  @Valid 
  @Schema(name = "BorrowDate", example = "2026-07-27", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("BorrowDate")
  public @Nullable LocalDate getBorrowDate() {
    return borrowDate;
  }

  public void setBorrowDate(@Nullable LocalDate borrowDate) {
    this.borrowDate = borrowDate;
  }

  public LoanResponse returnDate(@Nullable LocalDate returnDate) {
   ...
   */
  @Valid 
  @Schema(name = "returnDate", example = "2026-08-10", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("returnDate")
  public @Nullable LocalDate getReturnDate() {
    return returnDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, loanResponse.id) &&
        ...
        Objects.equals(this.returnDate, loanResponse.returnDate) &&
        Objects.equals(this.loanStatus, loanResponse.loanStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, userName, bookTitle, borrowDate, returnDate, loanStatus);
  }
